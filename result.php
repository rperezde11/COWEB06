...
<html>
    ...
    <body id="bod">
        ...
        <div id="header">
            ...
            <div id="whole-logo">
                <img id="logo" alt="Page Logo" src="imgs/logo.png"></img>
            </div>
            
            <div id="header-profile">
                <a href="register.html">
                    <img id="img-avatar" alt="Avatar image"  src="imgs/avatar.png"></img>
                </a>
            </div>
            ...
            <div id="dummy-selector">
                ...
                <div id="flight-selector">
					...
					<?php 
						...
						{
							$ocurrences += preg_match('[0-9]',$departure.$arrival);
							
							if($ocurrences == 0)
							{
								echo "<h2>$departure" . " - " . "$arrival</h2>";
								echo "<h4>$ocurrences</h4>";
							}
							else
							{
